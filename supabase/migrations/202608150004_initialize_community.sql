-- Hosted projects receive migrations but do not automatically receive the
-- local development seed. Create the one application community and its
-- default settings here so Auth signup can create a pending profile.
